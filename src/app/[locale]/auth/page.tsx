  ...
  return (
    <div className="max-w-md mx-auto px-4 py-16">
      <div className="text-center mb-8">
        ...
        <h1 className="text-2xl font-bold mb-2">{t("loginWith")}</h1>
      ...
      <div className="space-y-4">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 bg-white hover:bg-gray-50 text-gray-700 font-medium py-3 px-4 rounded-lg border border-gray-300 transition-colors"
        >
